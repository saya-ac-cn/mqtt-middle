...
public class DeviceController {
     ...
     * @Description
     */
    @GetMapping(value = "identify/{identify}")
    public Result<IotIdentifyEntity> getIotIdentify(@PathVariable("identify") String identify) {
        return deviceService.getIotIdentify(identify);
    }
